...
export default function Checkout() {
    ...
    const currentUser = { email: "user@example.com" }; // Replace with actual user state
    ...
    const onSubmit = data => {
        ...
        const newOrder = {
            name: data.name,
            email: currentUser?.email , // Ensure email is fetched correctly
            address: {
                city: data.city,
                            ...
                            <div className="lg:col-span-2">
                                <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                    ...
                                    <div className="md:col-span-5">
                                        ...
                                        <input {...register("email")} type="text" id="email" className="h-10 border mt-1 rounded px-4 w-full bg-gray-50" disabled defaultValue={currentUser?.email} />
                                    </div>
                                    <div className="md:col-span-5">
